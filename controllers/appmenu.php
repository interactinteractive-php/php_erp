...
class Appmenu extends Controller {
    ...
    public function market($menuCode = null) 
    {   
        $defaultModuleId = Session::get(SESSION_PREFIX . 'defaultModuleId');
        $redirectUrl = $this->redirectModule(null, $defaultModuleId);
        ...
        $this->view->render('header');
        $this->view->render('appmenu/appmarket');
        $this->view->render('footer');
    }        

    public function marketDetail($menuCode = null) 
    {   
        $defaultModuleId = Session::get(SESSION_PREFIX . 'defaultModuleId');
        $redirectUrl = $this->redirectModule(null, $defaultModuleId);
        ...
        $this->view->render('header');
        $this->view->render('appmenu/appmarket-detail');
        $this->view->render('footer');
    }    
    ...
    {   
        ...
        $this->view->render('header');
        $this->view->render('appmenu/appmarket-basket');
        $this->view->render('footer');
    }

    public function basket1($menuCode = null) 
    {   
        $defaultModuleId = Session::get(SESSION_PREFIX . 'defaultModuleId');
        $redirectUrl = $this->redirectModule(null, $defaultModuleId);
        ...
        $this->view->render('header');
        $this->view->render('appmenu/appmarket-basket1');
        $this->view->render('footer');
    }
