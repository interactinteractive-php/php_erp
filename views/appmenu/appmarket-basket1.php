                                ...
                                <div class="row">
                                    <div class="col-md-12 px-3 pb-0">
                                        <table class="table">
                                            <thead>
                                                <tr>
                                                    <th scope="col" class="w-50 header color1">Бүтээгдэхүүн</th>
                                                    <th scope="col" class="header color1">Хэрэглэгчийн тоо</th>
                                                    <th scope="col" class="header color1">Хугацаа /сараар/</th>
                                                    <th scope="col" class="header color1 d-flex justify-content-end">Дүн</th>
                                                    <th></th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <div class="d-flex px-3 py-1">
                                                            <img style="width:70px;height:70px;" src="https://dev.veritech.mn/storage/uploads/process/Group 21973.png" class="module-img mr-1 img-fluid rounded-circle my-auto" alt="img" onerror="onPortalDefaultSvg(this)">               
                                                            <div class="pl-1">
                                                                <div class="info-text-sub1">
                                                                    <div>Гэрээний удирдлагын систем</div>
                                                                </div>
                                                                <p class="pt-1">Гэрээнүүдээ зөв удирдасанаар бүхнийг алдаагүй гүйцэтгэх боломжтой.</p>
                                                                <div class="info-text-sub2">
                                                                    <a href="javascript:;" class="color2">1,000,000₮</a>
                                                                </div>
                                                            </div>
                                                        </div>    
                                                    </td>
                                                    <td>
                                                        <ul class="list-group list-group-horizontal market_basket_plus">
                                                            <li class="list-group-item px-2 py-1 border-right-0 minus" index="0"><i class="fa fa-minus"></i></li>
                                                            <li class="list-group-item px-2 py-1 border-x-0" id="return0">18</li>
                                                            <li class="list-group-item px-2 py-1 border-left-0 plus" index="0"><i class="fa fa-plus"></i></li>
                                                        </ul>
                                                    </td>
                                                    <td>
                                                        <ul class="list-group list-group-horizontal market_basket_plus">
                                                            <li class="list-group-item px-2 py-1 border-right-0 minusMonth" index="00"><i class="fa fa-minus"></i></li>
                                                            <li class="list-group-item px-2 py-1 border-x-0" id="return00">0</li>
                                                            <li class="list-group-item px-2 py-1 border-left-0 plusMonth" index="00"><i class="fa fa-plus"></i></li>
                                                        </ul>
                                                    </td>
                                                    <td> 
                                                        <div class="d-flex justify-content-end">
                                                            <div class="info-text-sub2">
                                                                <a href="javascript:;" class="color1">2,500,842₮</a>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <a href= "javascript:;" title="delete" onclick="delete(this)" class="btn">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>  
                                                        <ul class="list-group list-group-horizontal market_basket_plus">
                                                            <li class="list-group-item px-2 py-1 border-right-0 minus" index="1"><i class="fa fa-minus"></i></li>
                                                            <li class="list-group-item px-2 py-1 border-x-0" id="return1">0</li>
                                                            <li class="list-group-item px-2 py-1 border-left-0 plus" index="1"><i class="fa fa-plus"></i></li>
                                                        </ul>
                                                    </td>
                                                    <td>  
                                                        <ul class="list-group list-group-horizontal market_basket_plus">
                                                            <li class="list-group-item px-2 py-1 border-right-0 minusMonth" index="11"><i class="fa fa-minus"></i></li>
                                                            <li class="list-group-item px-2 py-1 border-x-0" id="return_month11">0</li>
                                                            <li class="list-group-item px-2 py-1 border-left-0 plusMonth" index="11"><i class="fa fa-plus"></i></li>
                                                        </ul>
                                                    </td>
                                                    <td> 
                                                        <div class="d-flex justify-content-end">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>  
                                                        <ul class="list-group list-group-horizontal market_basket_plus">
                                                            <li class="list-group-item px-2 py-1 border-right-0 minus" index="2"><i class="fa fa-minus"></i></li>
                                                            <li class="list-group-item px-2 py-1 border-x-0" id="return2">0</li>
                                                            <li class="list-group-item px-2 py-1 border-left-0 plus" index="2"><i class="fa fa-plus"></i></li>
                                                        </ul>
                                                    </td>
                                                    <td>  
                                                        <ul class="list-group list-group-horizontal market_basket_plus">
                                                            <li class="list-group-item px-2 py-1 border-right-0 minusMonth" index="22"><i class="fa fa-minus"></i></li>
                                                            <li class="list-group-item px-2 py-1 border-x-0" id="return_month22">0</li>
                                                            <li class="list-group-item px-2 py-1 border-left-0 plusMonth" index="22"><i class="fa fa-plus"></i></li>
                                                        </ul>
                                                    </td>
                                                    <td> 
                                                        <div class="d-flex justify-content-end">
                                        ...
                                        <div class="d-flex p-3">
                                            <div class="w-75">
                                                <div class="info-header-sub">
                                                    <p class="color3">Description</p>
                                                </div>
                                                <p class="text-justify mr-5 pb-2">
                                            ...
                                            <div class="pl-1">
                                                <ul class="list-group border-none">
                                                    <li class="br-5 list-group-item list-group-item-warning d-flex justify-content-between align-items-center px-1">
                                                        <div>
                                                            Гишүүний хөнгөлөлтийн эрх эдлэх
                                                        </div>
                                                        <div class="btn btn-light d-flex justify-content-between align-items-center ml-1 px-1 br-5">
                                                            <a href="javascript:;" class="mr-1 color3">-10%</a>
                                                            <div>
                                                    ...
                                                    <li class="list-group-item d-flex justify-content-between align-items-center p-0">
                                                        <h1 class="font-weight-bold">Нийт дүн</h1>
                                                        <h1 class="font-weight-bold total"> 8,500,842₮</h1>
                                                    </li>
                                                    <li class="list-group-item d-flex justify-content-center align-items-center" style="background:#468CE2; height:50px; border-radius:30px;">
                                                        <a href="javascript:;" class="font-weight-bold text-white fs-16">Худалдан авалт хийх</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div> 
