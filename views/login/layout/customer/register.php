...
<?php echo Form::create(array('id' => 'password-reset-form', 'class' => 'login-form', 'method' => 'post', 'action' => 'login/runRegister', 'autocomplete' => 'off')); ?>
...
<div class="col leftside carousel slide" id="loginSlider" data-ride="carousel">
    ...
    <div class="col-md-auto rightside">
        <div class="w-100">
            ...
            <div class="form-group form-group-feedback form-group-feedback-left">
                <div class="input-icon">
                    <?php echo Form::text(array('name' => 'p_registernumber', 'id' => 'p_registernumber', 'class' => 'form-control placeholder-no-fix', 'placeholder' => $this->lang->line('user_registernumber'), 'required' => 'required', 'autocomplete' => 'off', 'tabindex' => 1)); ?>
                    <div class="form-control-feedback">
            ...
            <div class="form-group form-group-feedback form-group-feedback-left">
                <div class="input-icon">
                    <?php echo Form::text(array('name' => 'p_lastname', 'id' => 'p_lastname', 'class' => 'form-control placeholder-no-fix', 'placeholder' => $this->lang->line('user_lastname'), 'required' => 'required', 'autocomplete' => 'off', 'tabindex' => 1)); ?>
                    <div class="form-control-feedback">
                        <i class="icon-user text-muted"></i>
                    </div>
                </div>
            ...
            <div class="form-group form-group-feedback form-group-feedback-left">
                <div class="input-icon">
                    <?php echo Form::text(array('name' => 'p_firstname', 'id' => 'p_firstname', 'class' => 'form-control placeholder-no-fix', 'placeholder' => $this->lang->line('user_firstname'), 'required' => 'required', 'autocomplete' => 'off', 'tabindex' => 1)); ?>
                    <div class="form-control-feedback">
                        <i class="icon-user text-muted"></i>
                    </div>
                </div>
            ...
            <div class="form-actions mt-4">
                <?php echo Form::submit(array('class' => 'btn btn-primary btn-block', 'value' => $this->lang->line('register_btn'), 'tabindex' => 3)); ?>
