...
<link href="<?php echo autoVersion('assets/custom/css/login_2.css'); ?>" rel="stylesheet" type="text/css"/>
...
<script src="<?php echo autoVersion('assets/core/js/plugins/forms/validation/validate.min.js'); ?>" type="text/javascript"></script>
</head>
<body>
