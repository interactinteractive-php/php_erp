...
<script src="<?php echo autoVersion('assets/core/js/main/jquery.min.js'); ?>"></script>
<script src="<?php echo autoVersion('assets/core/js/main/bootstrap.bundle.min.js'); ?>"></script>
<script src="<?php echo autoVersion('assets/core/js/plugins/forms/validation/validate.min.js'); ?>"></script>
</head>
<body>
