    ...
    <div class="col-md-auto rightside">
        <div class="w-100">
            ...
            <div class="form-group form-group-feedback form-group-feedback-left sign-user">
                <?php 
                echo Form::text(array('name' => 'user_name', 'id' => 'user_name', 'class' => 'form-control placeholder-no-fix', 'placeholder' => $this->lang->line('user_name'), 'required' => 'required', 'autocomplete' => 'off', 'spellcheck' => 'false')); 
                ?>
            ...
            <div class="pl-3 pr-3">
                ...
                echo html_tag('div', array('class' => 'ldap float-left activedir'), $this->ldapControl, $this->isLDap); 
                ?>
