<?php
    ...
    $pos6Arr = $this->layoutPositionArr['pos_6'];
                        ...
                        <?php 
                            if ($this->layoutPositionArr['pos_15']) {
                                foreach ($this->layoutPositionArr['pos_15'] as $key => $row) {
                                    ...
                                    $rowJson = htmlentities(json_encode($row), ENT_QUOTES, 'UTF-8'); ?>
                                <div class="event-box <?php echo Config::getFromCache('isNotaryServer') ? $class : '' ?>" data-rowdata="<?php echo $rowJson; ?>" data-id="<?php echo issetVar($row['id']) ?>">
                                    <div style="min-width:90px;float:left;">
                                        <div class="calendar-date project-data-group">
                                            <div class="d-flex flex-column">
                                                <h3 class="text-black d-flex align-items-center">
                                            ...
                                            <div class="d-flex align-items-center justify-content-between w-100 taskdesc app-req">
                                                <div class="d-flex">
                                                    ...
                                                    <div class="avatar mr-2">
                                                        <img src="<?php echo issetVar($row['picture']); ?>" class="rounded-circle" alt="" onerror="onUserImageError(this);">
                                                    </div>
                                                    <div class="mr-3" style="width:120px;">
                                                        <div><?php echo issetVar($row['employeename']); ?></div>
                                                        <div class="text-muted line-height-normal"><?php echo issetVar($row['positionname']); ?></div>
                                                    </div>
                                                    <?php } ?>
                                                    <div style="width:250px;">
                                                        <div><?php echo issetVar($row['booktypename']); ?></div>
                                                        <div class="text-muted line-height-normal"><?php echo issetVar($row['description']); ?> </div>
