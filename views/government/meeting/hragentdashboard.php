                                ...
                                ?>
                                    <li class="media" data-id="<?php echo $row['id'] ?>" style="cursor:pointer">
                                        <div class="media-left">
                                            ...
                                            <p><?php echo issetParam($row['digitday']) ?></p>
                                        </div>
                    ...
                    <?php if (issetParam($this->layoutPositionArr['pos_12'])) { ?>
                        <div id="carouselSlide2_<?php echo $this->uniqId ?>" class="carousel slide" data-ride="carousel">
                            <ol class="carousel-indicators">
                                <?php if ($this->layoutPositionArr['pos_12']) {
...
<!--                                                <div class="card-img-wrapper">
                                                ...
                                                <!--<div class="marker t-10 l-10 bg-success tx-white text-one-line">-->
                                                ...
                                                <div class="card-body" style="display:flex;">
                                                    ...
                                                    <div class="col-8 mt-3">
                                                        <p class="card-desc text-ten-line" style="height: 165px;"><?php echo issetParam($row['body']) ? Str::htmltotext($row['body']) : '' ?></p>
                                                    </div>
                                                    
                                                </div>
                                            </a>
                                            <div class="card-footer" style="background-color: #fff;border: none;position: relative;">
                                            </div>
                                        </div>
                                    </div>
                                <?php } ?>
                    ...
                    <div class="card card-hover card-profile-sidebar">
                        ...
                        <div class="table-responsive" style="max-height: 450px; height: 450px; ">
                            <?php if (issetParam($this->layoutPositionArr['pos_11'])) {
                                ...
                                $a5 = Date::format('Y-m-d', $currentDate);
                            ...
                            <?php if ($this->layoutPositionArr['pos_13']) {
                                foreach ($this->layoutPositionArr['pos_13'] as $key => $row) { ?>
                                    <div class="carousel-item <?php echo $key == '0' ? 'active' : ''; ?>">
                                        <a href="<?php echo issetVar($row['imgurl']) ? $row['imgurl'] : 'javascript:;' ?>" <?php echo issetVar($row['imgurl']) ? 'target="_blank"' : '' ?> class="marker t-10 l-10 bg-success tx-white">
                                            <?php echo issetVar($row['description']) ?>
                                        </a>
                                        <img class="d-block w-100" src="<?php echo issetVar($row['physicalpath']) ?>" alt="<?php echo issetVar($row['filename']) ?>" height="335">
                                    </div>
                                <?php }
                            } ?>
                        </div>
                    ...
                    <div class="card card-hover card-transactions card-forum">
                        ...
                        <ul class="list-group list-group-flush heleltsuuleg<?php echo $this->uniqId ?>">
                            <?php if (issetParam($this->layoutPositionArr['pos_9'])) {
                                ...
                                $rowJson = htmlentities(json_encode($row), ENT_QUOTES, 'UTF-8');
                            ?>
                                <li class="list-group-item align-items-center" data-id="<?php echo issetVar($row['id']) ?>">
                                    <a href="javascript:;" data-rowdata="<?php echo $rowJson; ?>" onclick="drilldownLink_intranet_<?php echo $this->uniqId ?>(this)">
                                        <div class="avatar mr-2">
                                            <img src="<?php echo issetVar($row['physicalpath']) ?>" class="rounded-circle" alt="" onerror="onUserImageError(this);" data-userid="<?php echo issetVar($row['userid']) ?>">
                                        </div>
                                    </a>
                                    <div class="mr-3">
                                        <a href="javascript:;" data-rowdata="<?php echo $rowJson; ?>" onclick="drilldownLink_intranet_<?php echo $this->uniqId ?>(this)" class="text-black">
                                            <h6><?php echo issetVar($row['description']) ?></h6>
                                        </a>
                                        <small><?php echo issetVar($row['positionname']) ?> <?php echo issetVar($row['name']) ?></small>
                                    ...
                                    <div class="ml-auto tx-right">
                                        ...
                                        if (issetVar($row['commentpersonname']) && $personname) { ?>
        ...
        <div style="width: 250px;" class="px-2">
            <div class="card card-hover card-profile-sidebar card-weather">
                ...
                <div class="p-3">
                    ...
                    <?php } else {
                        echo '<p style="color:#F44336">Цаг агаарын серверээс хариу ирсэнгүй.</p>';
                    } ?>
                </div>
            </div>
                ...
                <ul class="list-group list-group-flush">
                    ...
                    foreach ($this->layoutPositionArr['pos_4'] as $key => $row) { ?>
                        <li class="list-group-item align-items-center">
                            ...
                            <?php if (Config::getFromCache('USE_CHAT') && Config::getFromCache('isUseWebSocket')) { ?>
                    ...
                    <?php }} else { echo "<span class='text-muted p-2 pl15'>Өгөгдөл байхгүй байна.</span>"; } ?>
                    <!-- <li class="list-group-item align-items-center">
