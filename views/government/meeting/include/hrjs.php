    ...
    $(document).ready(function() {
        ...
        $('#calendar-<?php echo $this->uniqId ?>').fullCalendar({
            ...
            events: function (start, end, timezone, callback) {
                ...
                defaultCriteriaData = 'param%5BfilterStartDate%5D=' + filterStartDate + '&criteriaCondition%5BfilterStartDate%5D=%3D&param%5BfilterEndDate%5D=' + filterEndDate + '&criteriaCondition%5BfilterEndDate%5D=%3D&criteriaTemplates=&criteriaTemplateName=&criteriaTemplateDescription=&inputMetaDataId=<?php echo $this->layoutPositionArr['pos_6_dvid'] ?>';
                ...
                try {
                    ...
                    $.each(data.pos12, function (index, row) {
                        if ($mainSelectorSlide.find('ol.carousel-indicators > li[data-id="'+ index +'"]').length < 1) {
                            ...
                            $mainSelectorSlide.find('div.carousel-inner').append(row.html);
                        }
                    });
