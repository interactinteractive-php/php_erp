...
function elecMetaRegister(elem, processMetaDataId, dataViewId, selectedRow, paramData) {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            $dialog.on('hidden.bs.modal', function () {
                ...
                dataViewFirstColumnFocus(dataViewId);
...
function elecDirectScan(elem, processMetaDataId, dataViewId, selectedRow, paramData) {
    Core.blockUI({
        boxed: true, 
        message: 'Loading...'
    });
    ...
    if ("WebSocket" in window) {
		...
		if (selectedRow.hasOwnProperty('isftpscanid')){
        ...
        ws.onmessage = function (evt) {
            ...
            if (jsonData.status == 'success' && 'details' in Object(jsonData)) {
                ...
                $.ajax({
                    type: 'post',
                    // url: 'mddoc/electronRegisterLegalBulkScan',
                    url: 'contenui/elecDirectScan',
                    data: {recordId: recordId, filesObj: filesObj, nextWfmStatus: true, notFilesRender: true, selectedRow: selectedRow, timeId: timeId, paramData: newParamData},
                    dataType: 'json',
                    async: false, 
                    success: function (data) {
                        if (data.status == 'success') {
...
function elecReDirectScan(elem, processMetaDataId, dataViewId, selectedRow, paramData) {
    Core.blockUI({
        boxed: true, 
        message: 'Loading...'
    });
        ...
        ws.onmessage = function (evt) {
            ...
            if (jsonData.status == 'success' && 'details' in Object(jsonData)) {
                ...
                $.ajax({
                    type: 'post',
                    url: 'mddoc/electronRegisterLegalBulkReScan',
                    data: {recordId: recordId, filesObj: filesObj, nextWfmStatus: true, notFilesRender: true, selectedRow: selectedRow, paramData: newParamData},
                    dataType: 'json',
                    async: false, 
                    success: function (data) {
                        if (data.status == 'success') {
