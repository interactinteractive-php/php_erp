$(function(){
    ...
    $(document.body).on('click','#imageUpload',function(e){
        e.preventDefault();
        $('.post-images-upload').trigger('click');
    });
    
    $(document.body).on('change','.post-images-upload',function(e){
        e.preventDefault();
    ...
    $(document.body).on('change', '.post-video-upload',function(e){
        e.preventDefault();
        var files = !!this.files ? this.files : [];
