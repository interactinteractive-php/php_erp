...
;(function($) {
	$.fn.scriptcam=function(options) {
		...
		return this.each(function() {
			...
			if (fileExists(URL+'assets/custom/addon/plugins/webcam/scriptcam/scriptcam.swf')) {
				swfobject.embedSWF(URL+'assets/custom/addon/plugins/webcam/scriptcam/scriptcam.swf', opts.id, newWidth, newHeight, '11.6', false, opts, params);
			}
			else {
