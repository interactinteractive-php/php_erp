 ...
 * (end)
 */
if (typeof(window.mxGraphIgnoreIncludes) == 'undefined') {
    window.mxGraphIgnoreIncludes = false;
}
...
if (window.mxGraphIgnoreIncludes == false && (mxForceIncludes || !(typeof module === 'object' && module.exports != null)))
{
