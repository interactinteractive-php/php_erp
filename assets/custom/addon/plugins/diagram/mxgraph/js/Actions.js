...
Actions.prototype.init = function()
{
	...
	this.addAction('saveAs...', function() { ui.saveFile(true); }, null, null, Editor.ctrlKey + '+Shift+S').isEnabled = isGraphEnabled;*/
        ...
        this.addAction('export...', function() { ui.showDialog(new ExportDialog(ui).container, 300, 270, true, true); });
	...
	this.addAction('pageSetup...', function() { ui.showDialog(new PageSetupDialog(ui).container, 380, 230, true, true); }).isEnabled = isGraphEnabled;
	...
	this.addAction('fitWindow', function() { graph.fit(); }, null, null, Editor.ctrlKey + '+Shift+H');
        this.addAction('addProcess', function() { alert('Add process'); }, null, null, '');
