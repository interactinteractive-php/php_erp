...
$.extend(true, $.fn.dataTable.defaults, {
  "dom": "<'row'<'col-md-12 col-sm-12'l>r><'table-scrollable't><'row'<'col-md-5 col-sm-12'i><'col-md-7 col-sm-12'p>>", // horizobtal scrollable datatable
...
$.fn.dataTable.ext.renderer.pageButton.bootstrap=function(settings, host, idx, buttons, page,
        pages){
  ...
  "bootstrap_extended": {
    "fnInit": function(oSettings, nPaging, fnDraw){
      ...
      $(nPaging).append(
              ...
              '<a href="#" class="btn btn-sm default prev disabled" title="' + oLang.previous +
              ...
              '<a href="#" class="btn btn-sm default next disabled" title="' + oLang.next +
