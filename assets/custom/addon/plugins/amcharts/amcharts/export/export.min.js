...
b.action}),"change"==b.action&&a.setup.fabric.setActiveObject(d),a.setup.fabric.add(d),d;a.setup.fabric.add(d);return d}for(d=0;d<b.group.length;d++)b.group[d].noUndo=!0,a.setup.fabric.add(b.group[d]);return b}}},defaults:{position:"top-right",fileName:"amCharts",action:"download",overflow:!0,path:(v.path||"")+"assets/custom/addon/plugins/amcharts/amcharts/export/",formats:{JPG:{mimeType:"image/jpg",extension:"jpg",capture:!0},PNG:{mimeType:"image/png",extension:"png",capture:!0},SVG:{mimeType:"text/xml",extension:"svg",capture:!0},PDF:{mimeType:"application/pdf",
