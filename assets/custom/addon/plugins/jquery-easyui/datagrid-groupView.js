...
//            var groupRow, resetGroupSum = true, rowData = {};
...
//            table.push('<table style="display:inline-block;position:relative;left:-'+width+'px" class="datagrid-group-vr-group-sum-class" cellspacing="0" cellpadding="0" border="0"><tbody>');
        ...
        function initCss() {
            if (!$('#datagrid-group-style').length) {
                $('head').append(
                        ...
                        '.datagrid-group-vr-group-sum-class td{border-bottom: transparent;padding:4px;text-overflow: ellipsis;overflow: hidden;white-space: nowrap;}' +
