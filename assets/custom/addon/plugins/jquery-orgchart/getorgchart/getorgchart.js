...
getOrgChart.prototype.resize = function() {
 this._f();
 this._X._t.style.height = this._a8 + "px";
 this._X._u.style.height = this._a8 + "px";
 this._X._9.style.height = this._a8 + "px"
};
getOrgChart.prototype._f = function() {
 ...
 if (this._zO < 3) {
  this._zO = parseInt((this._zL * 9) / 16);
  this.element.style.height = this._zO + "px"
 }
 this._a9 = this._zL;
...
getOrgChart.prototype.draw = function(a) {
 ...
 if (this.config.enableSearch) {
  ...
  this._X._aV.style.display = "inherit";
  this._X._zc.style.display = "inherit"
 }
 if (this.config.enableZoom) {
  this._X._z6.style.display = "inherit";
  this._X._z4.style.display = "inherit"
 }
 ...
 if (this.config.enableMove) {
  ...
  this._X._ao.style.display = "inherit";
...
getOrgChart.prototype._e = function() {
 ...
 for (i = 0; i < this._X._aK.length; i++) {
...
getOrgChart.node.prototype.draw = function(a) {
 ...
 h.push(getOrgChart.OPEN_NODE.replace("[data-node-id]", this.id).replace("[x]", this._z1 == null ? this.x : this._z1).replace("[y]", this._z2 == null ? this.y : this._z2).replace("[level]", this.level).replace("[nodeCssClass]", d));
